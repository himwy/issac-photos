    ...
    <section id="contact" className="py-24 px-6">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          <h2 className="font-serif text-5xl md:text-6xl font-light mb-4 text-balance">Get In Touch</h2>
          <p className="text-muted-foreground text-lg text-pretty">Let's create something beautiful together</p>
        </div>
