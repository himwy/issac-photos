      ...
      <main className="pt-40 pb-24">
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          <motion.section
            ...
            className="mb-32"
          >
            <h1 className="text-5xl md:text-6xl font-light mb-16 tracking-tight">
              About
            </h1>
            ...
            <div className="grid md:grid-cols-3 gap-12 md:gap-20">
              <div className="md:col-span-2 space-y-6 text-lg leading-relaxed text-gray-700">
                <p>
                  We are Issac, a creative duo based in [Your City]. We
                  specialize in photography and visual storytelling, capturing
                  moments that resonate.
                </p>
                <p>
                  Our work spans editorial photography, commercial projects, and
                  personal documentary series. We're drawn to authentic stories
                  and the beauty in everyday moments.
                </p>
                <p>
                  With a passion for creativity and attention to detail, we
                  collaborate with clients to bring their vision to life through
                  thoughtful, artistic imagery.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <p className="text-lg text-gray-600 leading-relaxed mb-12">
                  Available for commissions, collaborations, and creative
                  projects. Let's create something beautiful together.
                </p>
              </div>
