...
const projectData: Record<string, {
  ...
  "1": { title: "Urban Stories", year: "2024", category: "Documentary", description: "A photographic exploration of urban life and city dwellers." },
  "2": { title: "Golden Hour", year: "2024", category: "Landscape", description: "Capturing the magic of golden hour light." },
  "3": { title: "Architectural", year: "2023", category: "Architecture", description: "Exploring modern architecture through a minimalist lens." },
};
    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <main className="pt-40 pb-24">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          {/* Back Link */}
          <Link href="/" className="inline-flex items-center text-sm text-gray-500 hover:text-black transition-colors mb-12">
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <h1 className="text-5xl md:text-6xl font-light mb-12 tracking-tight">{project.title}</h1>
            ...
            <div className="grid md:grid-cols-4 gap-12">
              ...
              <div>
                <p className="text-xs uppercase tracking-widest text-gray-400 mb-2">Year</p>
          ...
          >
            {[1, 2, 3].map((i) => (
              <div key={i} className={`relative ${i === 2 ? 'aspect-square' : 'aspect-video'} bg-gray-200`}>
                <div className="absolute inset-0 flex items-center justify-center bg-linear-to-br from-gray-300 to-gray-200">
                  <span className="text-gray-400 text-xs tracking-widest">IMAGE {i}</span>
                </div>
              </div>
            ))}
          </motion.div>
          ...
          <div className="mt-24 pt-12 border-t border-gray-200">
            <Link href="/" className="inline-flex items-center text-sm hover:opacity-50 transition-opacity">
